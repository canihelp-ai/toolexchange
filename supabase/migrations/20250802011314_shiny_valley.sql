/*
  ...
  1. New Tables with Sample Data
    - Uses existing profile for Darren Hamilton (admin role)
...
-- Create tools owned by the user (using existing profile: Darren Hamilton)
INSERT INTO tools (
  owner_id,
  title,
  description,
...
('88cb0910-4628-490c-b4be-44d1e4abc05c', 'DeWalt 20V Max Cordless Drill Set', 'Professional-grade cordless drill with 2 batteries, charger, and carrying case. Perfect for construction and home projects.', 'Power Tools', 'DeWalt', 'DCD771C2', '4 Wishaw Drive, kgn 8', 'excellent', '{"Max Torque": "300 UWO", "Chuck Size": "1/2 inch", "Battery": "20V MAX", "Weight": "3.6 lbs"}', 'fixed', 15, 45, 280, NULL, NULL, false, false, true, 12, 24, 4.8, 34, ARRAY['2 Batteries', 'Fast Charger', 'LED Light', 'Belt Clip'], ARRAY['No wet conditions', 'Return clean', 'Report any damage immediately'], 100, 'active', 245, 18),
('88cb0910-4628-490c-b4be-44d1e4abc05c', 'Compact Excavator - Bobcat E35', 'Perfect for small construction projects, landscaping, and utility work. Includes operator service available.', 'Heavy Equipment', 'Bobcat', 'E35', '4 Wishaw Drive, kgn 8', 'good', '{"Operating Weight": "8,000 lbs", "Max Dig Depth": "11 ft 2 in", "Bucket Capacity": "0.28 yd³", "Engine Power": "24.8 HP"}', 'fixed', NULL, 320, 1800, NULL, NULL, true, true, true, 150, 300, 4.9, 12, ARRAY['Hydraulic Thumbs', 'Rubber Tracks', 'Auxiliary Hydraulics', 'Enclosed Cab'], ARRAY['Valid license required', 'Operator must be present', 'No weekend returns'], 1500, 'active', 89, 7),
('88cb0910-4628-490c-b4be-44d1e4abc05c', 'Professional Tile Saw - MK Diamond', 'High-precision tile saw for professional and DIY projects. Includes diamond blade and water pump system.', 'Construction Tools', 'MK Diamond', 'MK-370EXP', '4 Wishaw Drive, kgn 8', 'excellent', '{"Cutting Capacity": "12 inches", "Blade Size": "7 inches", "Motor": "1 HP", "Water System": "Integrated pump"}', 'bidding', NULL, 85, 500, 65, 75, true, false, true, 25, 50, 4.7, 23, ARRAY['Diamond Blade', 'Water Cooling', 'Portable Stand', 'Dust Collection'], ARRAY['Provide own extension cord', 'Clean after use', 'No concrete cutting'], 200, 'active', 156, 12),
('88cb0910-4628-490c-b4be-44d1e4abc05c', 'Milwaukee M18 Circular Saw', 'Powerful cordless circular saw with brushless motor. Includes blade and battery.', 'Power Tools', 'Milwaukee', 'M18CCS66', '4 Wishaw Drive, kgn 8', 'good', '{"Blade Size": "6.5 inches", "Battery": "M18", "Motor": "Brushless", "Cut Capacity": "2-9/16 inches"}', 'fixed', 12, 35, 210, NULL, NULL, false, false, true, 10, 20, 4.6, 28, ARRAY['Brushless Motor', 'LED Light', 'Magnesium Guards', 'Rafter Hook'], ARRAY['Use proper safety gear', 'Check blade before use', 'No metal cutting'], 75, 'active', 198, 15),
('88cb0910-4628-490c-b4be-44d1e4abc05c', 'Skid Steer Loader - Caterpillar 226D', 'Versatile skid steer for construction and landscaping. Operator required for operation.', 'Heavy Equipment', 'Caterpillar', '226D', '4 Wishaw Drive, kgn 8', 'good', '{"Operating Weight": "7,500 lbs", "Rated Operating Capacity": "2,000 lbs", "Engine Power": "74 HP", "Lift Height": "10.5 ft"}', 'fixed', NULL, 280, 1680, NULL, NULL, true, true, true, 120, 240, 4.7, 18, ARRAY['Hydraulic Attachments', 'Enclosed Cab', 'Joystick Controls', 'Backup Alarm'], ARRAY['Licensed operator required', 'No smoking in cab', 'Daily inspection required'], 1200, 'active', 134, 9),
('88cb0910-4628-490c-b4be-44d1e4abc05c', 'Makita Angle Grinder Set', 'Professional angle grinder with multiple discs and carrying case. Great for metal and masonry work.', 'Power Tools', 'Makita', 'GA7021', '4 Wishaw Drive, kgn 8', 'excellent', '{"Disc Size": "7 inches", "Motor": "15 Amp", "Speed": "8,500 RPM", "Weight": "5.1 lbs"}', 'bidding', NULL, 25, 150, 18, 22, false, false, true, 8, 16, 4.5, 31, ARRAY['Multiple Discs', 'Side Handle', 'Wheel Guard', 'Carrying Case'], ARRAY['Wear safety glasses', 'Secure workpiece', 'Check disc condition'], 50, 'active', 167, 11),
('88cb0910-4628-490c-b4be-44d1e4abc05c', 'Concrete Mixer - Honda GX160', 'Portable concrete mixer perfect for small to medium projects. Easy to transport and operate.', 'Construction Tools', 'Honda', 'CM4A-GX160', '4 Wishaw Drive, kgn 8', 'good', '{"Capacity": "4 cubic feet", "Engine": "Honda GX160", "Drum Speed": "28 RPM", "Weight": "185 lbs"}', 'fixed', 8, 55, 330, NULL, NULL, false, false, true, 15, 30, 4.4, 19, ARRAY['Honda Engine', 'Steel Drum', 'Pneumatic Tires', 'Easy Pour Design'], ARRAY['Clean after each use', 'Check oil level', 'No overloading'], 150, 'active', 143, 8),
('88cb0910-4628-490c-b4be-44d1e4abc05c', 'Pressure Washer - Generac 3100 PSI', 'High-pressure washer for cleaning driveways, decks, and equipment. Includes multiple nozzles.', 'Cleaning Equipment', 'Generac', 'G0079530', '4 Wishaw Drive, kgn 8', 'excellent', '{"Pressure": "3100 PSI", "Flow Rate": "2.4 GPM", "Engine": "196cc OHV", "Hose Length": "25 feet"}', 'fixed', 10, 40, 240, NULL, NULL, false, false, true, 12, 24, 4.6, 26, ARRAY['Multiple Nozzles', 'Soap Tank', 'Quick Connect', 'Pneumatic Tires'], ARRAY['Use appropriate nozzle', 'No hot water', 'Protect electrical connections'], 80, 'active', 189, 14),
('88cb0910-4628-490c-b4be-44d1e4abc05c', 'Welding Machine - Lincoln Electric', 'Professional MIG welder suitable for various metal fabrication projects. Includes accessories.', 'Welding Equipment', 'Lincoln Electric', 'Power MIG 210 MP', '4 Wishaw Drive, kgn 8', 'good', '{"Input Power": "208-575V", "Output": "40-210A", "Wire Size": "0.023-0.045 inch", "Duty Cycle": "30% at 210A"}', 'bidding', NULL, 95, 570, 78, 85, true, false, true, 35, 70, 4.8, 22, ARRAY['Multi-Process', 'Digital Display', 'Auto-Set', 'Spool Gun Ready'], ARRAY['Certified welder only', 'Proper ventilation required', 'Safety gear mandatory'], 300, 'active', 112, 6),
('88cb0910-4628-490c-b4be-44d1e4abc05c', 'Chainsaw - Stihl MS 271', 'Professional chainsaw for tree cutting and firewood preparation. Well-maintained and sharp chain.', 'Outdoor Equipment', 'Stihl', 'MS 271', '4 Wishaw Drive, kgn 8', 'excellent', '{"Engine": "50.2cc", "Bar Length": "20 inches", "Weight": "12.3 lbs", "Fuel Tank": "16.9 fl oz"}', 'fixed', 18, 60, 360, NULL, NULL, false, false, true, 20, 40, 4.7, 29, ARRAY['Anti-Vibration', 'Easy Start', 'Chain Brake', 'Tool-Free Adjustment'], ARRAY['Experience required', 'Safety gear mandatory', 'No lending to others'], 200, 'active', 176, 13);

-- Create tool images (2 per tool)
INSERT INTO tool_images (tool_id, image_url, is_primary) VALUES
((SELECT id FROM tools WHERE title = 'DeWalt 20V Max Cordless Drill Set'), 'https://images.pexels.com/photos/209274/pexels-photo-209274.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', true),
((SELECT id FROM tools WHERE title = 'DeWalt 20V Max Cordless Drill Set'), 'https://images.pexels.com/photos/1015568/pexels-photo-1015568.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', false),
((SELECT id FROM tools WHERE title = 'Compact Excavator - Bobcat E35'), 'https://images.pexels.com/photos/1078884/pexels-photo-1078884.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', true),
((SELECT id FROM tools WHERE title = 'Compact Excavator - Bobcat E35'), 'https://images.pexels.com/photos/1078883/pexels-photo-1078883.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', false),
((SELECT id FROM tools WHERE title = 'Professional Tile Saw - MK Diamond'), 'https://images.pexels.com/photos/1216589/pexels-photo-1216589.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', true),
((SELECT id FROM tools WHERE title = 'Professional Tile Saw - MK Diamond'), 'https://images.pexels.com/photos/1216590/pexels-photo-1216590.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', false),
((SELECT id FROM tools WHERE title = 'Milwaukee M18 Circular Saw'), 'https://images.pexels.com/photos/209274/pexels-photo-209274.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', true),
((SELECT id FROM tools WHERE title = 'Milwaukee M18 Circular Saw'), 'https://images.pexels.com/photos/1015568/pexels-photo-1015568.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', false),
((SELECT id FROM tools WHERE title = 'Skid Steer Loader - Caterpillar 226D'), 'https://images.pexels.com/photos/1078884/pexels-photo-1078884.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', true),
((SELECT id FROM tools WHERE title = 'Skid Steer Loader - Caterpillar 226D'), 'https://images.pexels.com/photos/1078883/pexels-photo-1078883.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', false),
((SELECT id FROM tools WHERE title = 'Makita Angle Grinder Set'), 'https://images.pexels.com/photos/209274/pexels-photo-209274.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', true),
((SELECT id FROM tools WHERE title = 'Makita Angle Grinder Set'), 'https://images.pexels.com/photos/1015568/pexels-photo-1015568.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', false),
((SELECT id FROM tools WHERE title = 'Concrete Mixer - Honda GX160'), 'https://images.pexels.com/photos/1216589/pexels-photo-1216589.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', true),
((SELECT id FROM tools WHERE title = 'Concrete Mixer - Honda GX160'), 'https://images.pexels.com/photos/1216590/pexels-photo-1216590.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', false),
((SELECT id FROM tools WHERE title = 'Pressure Washer - Generac 3100 PSI'), 'https://images.pexels.com/photos/209274/pexels-photo-209274.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', true),
((SELECT id FROM tools WHERE title = 'Pressure Washer - Generac 3100 PSI'), 'https://images.pexels.com/photos/1015568/pexels-photo-1015568.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', false),
((SELECT id FROM tools WHERE title = 'Welding Machine - Lincoln Electric'), 'https://images.pexels.com/photos/1216589/pexels-photo-1216589.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', true),
((SELECT id FROM tools WHERE title = 'Welding Machine - Lincoln Electric'), 'https://images.pexels.com/photos/1216590/pexels-photo-1216590.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', false),
((SELECT id FROM tools WHERE title = 'Chainsaw - Stihl MS 271'), 'https://images.pexels.com/photos/209274/pexels-photo-209274.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', true),
((SELECT id FROM tools WHERE title = 'Chainsaw - Stihl MS 271'), 'https://images.pexels.com/photos/1015568/pexels-photo-1015568.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=1', false);

-- Create tool availability for each tool
INSERT INTO tool_availability (tool_id, start_date, end_date, blocked_dates) VALUES
((SELECT id FROM tools WHERE title = 'DeWalt 20V Max Cordless Drill Set'), '2025-01-20', '2025-12-31', ARRAY['2025-02-10', '2025-02-11']::date[]),
((SELECT id FROM tools WHERE title = 'Compact Excavator - Bobcat E35'), '2025-01-25', '2025-11-30', ARRAY['2025-03-15', '2025-03-16', '2025-03-17']::date[]),
((SELECT id FROM tools WHERE title = 'Professional Tile Saw - MK Diamond'), '2025-01-22', '2025-10-31', ARRAY[]::date[]),
((SELECT id FROM tools WHERE title = 'Milwaukee M18 Circular Saw'), '2025-01-18', '2025-12-15', ARRAY['2025-04-01', '2025-04-02']::date[]),
((SELECT id FROM tools WHERE title = 'Skid Steer Loader - Caterpillar 226D'), '2025-02-01', '2025-11-15', ARRAY['2025-05-20', '2025-05-21']::date[]),
((SELECT id FROM tools WHERE title = 'Makita Angle Grinder Set'), '2025-01-15', '2025-12-20', ARRAY['2025-06-10']::date[]),
((SELECT id FROM tools WHERE title = 'Concrete Mixer - Honda GX160'), '2025-01-30', '2025-10-15', ARRAY['2025-07-04', '2025-07-05']::date[]),
((SELECT id FROM tools WHERE title = 'Pressure Washer - Generac 3100 PSI'), '2025-01-12', '2025-12-10', ARRAY['2025-08-15']::date[]),
((SELECT id FROM tools WHERE title = 'Welding Machine - Lincoln Electric'), '2025-02-05', '2025-11-25', ARRAY['2025-09-01', '2025-09-02']::date[]),
((SELECT id FROM tools WHERE title = 'Chainsaw - Stihl MS 271'), '2025-01-28', '2025-12-05', ARRAY['2025-10-31']::date[]);
...
('tool', (SELECT id FROM tools WHERE title = 'DeWalt 20V Max Cordless Drill Set'), (SELECT id FROM profiles WHERE email = 'zion2999@gmail.com'), (SELECT id FROM bookings WHERE tool_id = (SELECT id FROM tools WHERE title = 'DeWalt 20V Max Cordless Drill Set') LIMIT 1), 5, 'Excellent drill! Very powerful and the batteries lasted the entire project. Darren was very responsive and helpful.', 5, 5, 5, 4, ARRAY[]::text[], 3),
...
('owner', (SELECT id FROM profiles WHERE email = 'zion2999@gmail.com'), (SELECT id FROM profiles WHERE email = 'zion2999@gmail.com'), (SELECT id FROM bookings LIMIT 1), 5, 'Darren is an excellent tool owner. Professional, responsive, and his equipment is top-notch. Will rent again!', 5, 5, 5, 5, ARRAY[]::text[], 8),
...
((SELECT id FROM profiles WHERE email = 'zion2999@gmail.com'), 'message', 'Message Reply', 'Darren replied to your message about the concrete mixer', true, '/dashboard/messages'),
